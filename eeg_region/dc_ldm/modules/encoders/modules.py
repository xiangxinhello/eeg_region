...
#         self.transformer = CLIPTextModel.from_pretrained(version)
        self.tokenizer = CLIPTokenizer.from_pretrained('/home/dream_/DreamDiffusion/transformers')
        self.transformer = CLIPTextModel.from_pretrained('/home/dream_/DreamDiffusion/transformers')
...
class FrozenImageEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):
        ...
        self.transformer = CLIPVisionModelWithProjection.from_pretrained('/home/dream_/DreamDiffusion/transformers')
        self.device = device
        self.max_length = max_length
        self.freeze()
