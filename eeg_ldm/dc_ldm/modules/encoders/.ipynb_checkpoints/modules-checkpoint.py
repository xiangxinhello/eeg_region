...
#         self.transformer = CLIPTextModel.from_pretrained(version)
        self.tokenizer = CLIPTokenizer.from_pretrained('/root/autodl-tmp/huggingface/transformers')
        self.transformer = CLIPTextModel.from_pretrained('/root/autodl-tmp/huggingface/transformers')
...
class FrozenImageEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):
        ...
        self.transformer = CLIPVisionModelWithProjection.from_pretrained('/root/autodl-tmp/huggingface/transformers')
        self.device = device
        self.max_length = max_length
        self.freeze()
